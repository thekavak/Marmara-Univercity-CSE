...
$sql1 = "SELECT * FROM v_detailOfClients ORDER BY UserID DESC";
                        ...
                        ?>
                           <tr>
                            ...
                            <td><?php echo $data['Age']; ?></td>
                             ...
                             <td>
                                 <a href="client-detail.php?id=<?php echo $data['UserID']?>"> <button type="button" class="btn btn-primary btn-sm">
                Detail 
              </button></td>
                          </tr>
                      <?php   
